...
function WideButton({
	...
	const cls = [
		...
		variant === "red"
			...
			: "border-white/[0.08] bg-white/[0.04] text-[#D9D9D9]/70 hover:bg-white/[0.08] hover:text-white",
	].join(" ");
	return href ? (
		<Link href={href} className={cls}>
			{children}
			...
			>
				...
				>
					...
					<div className="flex items-center gap-3">
						...
						<PillButton href="/map" variant="red">
							Create Report
						</PillButton>
					</div>
				</header>
				...
				>
					...
					>
						<CardHeader
							...
							right={
								<PillButton href="/dashboard/citizen/shortcuts">
									Shortcuts
								</PillButton>
							}
						/>
						...
						>
							<WideButton href="/map" variant="red">
								Create report
							</WideButton>
